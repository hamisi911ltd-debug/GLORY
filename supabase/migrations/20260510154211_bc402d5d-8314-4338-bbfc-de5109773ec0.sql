...
-- Roles enum
create type public.app_role as enum ('super_admin', 'branch_admin', 'instructor', 'finance', 'examiner', 'student');
...
-- Security definer function to safely check roles in RLS
